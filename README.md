<h1 align="center">Jellyfin GenAPIre Plugin</h1>
...
3. Place the dll-file in the `plugins/GenAPIre` folder (you might need to create the folders) of your JF install
