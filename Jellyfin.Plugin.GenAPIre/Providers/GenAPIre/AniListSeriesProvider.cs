...
namespace Jellyfin.Plugin.GenAPIre.Providers.GenAPIre
{
    public class AniListSeriesProvider : IRemoteMetadataProvider<Series, SeriesInfo>, IHasOrder
    {
        ...
        public async Task<MetadataResult<Series>> GetMetadata(SeriesInfo info, CancellationToken cancellationToken)
        {
            ...
            var aid = info.ProviderIds.GetOrDefault(ProviderNames.GenAPIre);
            ...
            else
            {
                ...
                if (config.UseAnitomyLibrary)
                {
                    ...
                    _log.LogInformation("Start GenAPIre... Searching({Name})", searchName);
            ...
            if (media is not null)
            {
                ...
                result.Provider = ProviderNames.GenAPIre;
            }
        ...
        public async Task<IEnumerable<RemoteSearchResult>> GetSearchResults(SeriesInfo searchInfo, CancellationToken cancellationToken)
        {
            ...
            var aid = searchInfo.ProviderIds.GetOrDefault(ProviderNames.GenAPIre);
            if (!string.IsNullOrEmpty(aid))
            {
