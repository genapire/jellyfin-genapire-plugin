    ...
    public class MediaSearchResult
    {
        ...
        public RemoteSearchResult ToSearchResult()
        {
            ...
            return new RemoteSearchResult
            {
                ...
                SearchProviderName = ProviderNames.GenAPIre,
                ProviderIds = new Dictionary<string, string>() {{ProviderNames.GenAPIre, id.ToString(CultureInfo.InvariantCulture)}}
            };
        }
    }
            ...
            foreach (CharacterEdge edge in characters.edges)
            {
                foreach (Staff va in edge.voiceActors)
                {
                    ...
                    PeopleHelper.AddPerson(lpi, new PersonInfo {
                        ...
                        ProviderIds = new Dictionary<string, string>() {{ProviderNames.GenAPIre, va.id.ToString(CultureInfo.InvariantCulture)}},
                    });
                }
            }
